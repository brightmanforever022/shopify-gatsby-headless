...
const CollectionPageNonRoseSkeleton = React.memo(function CollectionPageSkeleton() {
  return (
    <section>
...
CollectionPageNonRoseSkeleton.displayName = 'CollectionPageNonRoseSkeleton';

export default CollectionPageNonRoseSkeleton;